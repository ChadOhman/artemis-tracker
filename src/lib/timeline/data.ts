...
const ACTIVITIES: TimelineActivity[] = [
  ...
  act("PAO Event", "pao", 0, 7, 30, 0, 8, 0),
  act("Sleep Period 1", "sleep", 0, 8, 0, 0, 12, 0, "4-hour rest period"),
  act("PRB Prep", "config", 0, 12, 0, 0, 13, 20),
  act("Perigee Raise Burn", "maneuver", 0, 13, 20, 0, 13, 40, "Orion PRB"),
  act("DSN Operations", "config", 0, 13, 40, 0, 14, 0, "DSN comm checkout"),
  act("OpNav Checkout", "science", 0, 14, 0, 0, 14, 30, "Optical Navigation"),
  act("Post-OpNav Config", "config", 0, 14, 30, 0, 17, 0),
  act("Sleep Period 2", "sleep", 0, 17, 0, 0, 21, 30, "4.5-hour rest period"),
