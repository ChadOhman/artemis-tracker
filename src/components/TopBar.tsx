      ...
      <div className="topbar-pill topbar-hide-mobile" aria-live="polite" aria-atomic="true" style={{ ...pillStyle, gap: 10 }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
          ...
          <span style={valueStyle}>
            {telemetry ? (speedUnit === "km/h" ? formatNumber(telemetry.speedKmH) : speedUnit === "mph" ? formatNumber(telemetry.speedKmH * 0.621371) : speedUnit === "kn" ? formatNumber(telemetry.speedKmH * 0.539957) : (telemetry.speedKmS * 1000).toFixed(1)) : "—"}
          </span>
